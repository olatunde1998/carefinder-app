...
import { DiseaseOne, DiseaseThree, DiseaseTwo } from "../../../assets/icons/conditionIcons";
...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <div className="">
        <Image src="/images/heroImage-one.png" width={500} height={500} alt="doctor pics" />
        <Image src="/images/heroImage-two.png" width={500} height={500} alt="doctor pics" />
        <Image src="/images/scribbble.png" width={500} height={500} alt="doctor pics" />
      </div>
